=for stopwords
AFS PAG auth Heimdal libkafs aklog KRB5CCNAME kaserver appdefaults API
unlog kdestroy nopag notokens SIGSYS krb524 Kerberos username login sshd
Kerberos-v5-derived
...
Add this option on Mac OS X, where PAGs are not supported (at least as of
